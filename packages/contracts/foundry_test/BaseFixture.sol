...
contract eBTCBaseFixture is Test {
    ...
    uint256 internal constant COLLATERAL_RATIO_DEFENSIVE = 500e16; // 250% - defensive CR
    uint internal constant MIN_NET_DEBT = 2000e18; // Subject to changes once CL is changed
