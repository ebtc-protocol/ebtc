 ...
 */
contract EToFoundry is Test, FoundryAsserts, TargetFunctions, EchidnaProperties {
    ...
    function test_pys03() public {
        ...
        assertTrue(invariant_PYS_03(cdpManager, vars), "PYS");
    ...
    function test_pys04() public {
        setEthPerShare(
            99930128941342140000266291552701334095267781396938829755845405936407078624212
        );
        setGovernanceParameters(
            703936011954574190096648107132477385862451789338,
            921840306035071876313799756458405179838510662337
        );

        assertTrue(invariant_PYS_04(cdpManager, vars), "PYS");
    ...
    function test_observe_pys() public {
        redeemCollateral(
            uint256(90458316914717687018285766791880846721660733942214271788798389244204902476436),
            bytes32(0x9984ecefafb4976872527b3d689e455b678d5fbcb6f2a774aaa77868bf7787ee),
            525600000,
            false,
            true,
            false,
            80444820362816977085570302672334763444553857845933241468982361145635920126096,
    ...
    function test_echidna_GENERAL_19() public {
        ...
        redeemCollateral(
            79535811480921385075613638753076253022779147871111159552744519620652667383301,
            bytes32(0x2337fbe6b0de0d43dbbc3cea2dd4e93de3df62424d0cac43801da0984d40f4e9),
            967132654952507783299167304032791279490280620328,
            false,
            true,
            true,
            35318840368464762976683892081176931813236465855817304324070807662237527033729,
            7
        );
        adjustCdp(
            528117742564021316393271938429391066789996829083,
            89640239480504075107596920309519069394391085781043110840553585090728759853056,
            65836381767953292916116827710951075734401640722998164525497771436128998279695,
            false
        );

        assertTrue(invariant_GENERAL_19(activePool), "GEN_19");
    }

    function test_echidna_PYS_01() public {
        setEthPerShare(1000000000000000000000000);
        setEthPerShare(
            115792089237316195423570985008687907853269984665640564039457584007913129639851
        );
        setGovernanceParameters(16, 0);
        setEthPerShare(
            107255381416776339463566659553951964104195326848432414062452240917269290912885
        );
        setEthPerShare(
    ...
    function test_echidna_PYS_03_B() public {
        ...
        setEthPerShare(
            115792089237316195423570985008687907853269984665640564039457584007913129635136
        );
    }
    ...
    function test_echidna_coll_surplus_pool_invariant_2() public {
        ...
        redeemCollateral(
            189528868517225480592232,
            bytes32(0x5eeed1af03563e995b9ab2720adbe1cb1ee15a976f6686520414cca85302b37f),
            115792089237316195423570985008687907853269984665640564039457534007913129639918,
            false,
            false,
            true,
            115792089237316195423570985007272045719787830250843198431889343271055891324045,
            65518
        );
    }
}
