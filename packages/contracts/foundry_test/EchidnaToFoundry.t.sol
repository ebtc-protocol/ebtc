    ...
    IERC3156FlashBorrower
{
    ...
    function testLS01_C4_155_Fix() public {
        openCdp(
            99686158942256384475585699555058856948620557112153554633770539191788460073690,
            131072
        );
        setPrice(115792089237316195423570985008198810721880820191385488431341416649195333555294);
        openCdp(
        ...
        setEthPerShare(
            61587483879812404764875978678708800597666291032886644784571712062555836835675
        );
        closeCdp(110401339754880309323747848141327184202391586024618427353076235401705000743024);
        setEthPerShare(10000000000000000);
        assertTrue(
            invariant_LS_01(
                cdpManager,
    ...
    function testSL05_C4_155_Fix() public {
        ...
        setEthPerShare(
            57748692526922562782277279227425885207982128228253469937796591373547046776368
        );
        openCdp(
            115792089237316195423570985008687907853269984665640564039457584007913129574400,
            1100000000000000000
        ...
        setEthPerShare(
            115792089237316195423570985007360116423738293101613986782245974018581911199881
        );
        setEthPerShare(
