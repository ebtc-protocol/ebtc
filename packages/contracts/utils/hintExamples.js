...
async function main() {
 ...
 const { cdpManager, borrowerOperations, hintHelpers, sortedCdps, priceFeedTestnet, btcPriceFeedTestnet } = coreContracts
  ...
  const btcPrice = await btcPriceFeedTestnet.getPrice()
  ...
  const redemptionhint = await hintHelpers.getRedemptionHints(EBTCAmount, price, btcPrice, 50)
