...
contract('CdpManager', async accounts => {
  ...
  it("11 accounts with random coll. 1 liquidation. 10 accounts do Cdp operations (apply rewards)", async () => {
    ...
    await borrowerOperations.openCdp(0, dec(170, 18), accounts[0], { from: accounts[0], value: dec(1, 'ether') })

    await th.openCdp_allAccounts_randomETH(1, 2, accounts.slice(1, 10), contracts, dec(170, 18))
  ...
  /* ABDK64, no error correction:
    ...
    EBTCDebt left in Default Pool is: 98

    DeciMath, no error correction:
    ETH left in Default Pool is: 7
    EBTCDebt left in Default Pool is: 37

    Pure division, no correction for rewards:
    ETH left in Default Pool is: 52
    EBTCDebt left in Default Pool is: 96
  */

  it("101 accounts with random coll. 1 liquidation. 100 accounts do a Cdp operation (apply rewards)", async () => {
    await borrowerOperations.openCdp(0, 0, accounts[999], { from: accounts[999], value: dec(1000, 'ether') })
    await borrowerOperations.openCdp(0, dec(170, 18), accounts[0], { from: accounts[0], value: dec(1, 'ether') })

    await th.openCdp_allAccounts_randomETH(1, 2, accounts.slice(1, 100), contracts, dec(170, 18))
  ...
  /* ABDK64, no error correction:
    ...
    EBTCDebt left in Default Pool is: 108
    ...
    EBTCDebt left in Default Pool is: 653
  */

  it("11 accounts. 1 liquidation. 10 accounts do Cdp operations (apply rewards)", async () => {
    await borrowerOperations.openCdp(0, 0,  accounts[99], { from: accounts[99], value: dec(100, 'ether') })

    await th.openCdp_allAccounts(accounts.slice(0, 10), contracts, dec(1, 'ether'), dec(170, 18))
  ...
  /* ABDK64, no error correction:
    ...
    EBTCDebt left in Default Pool is: 75 
  ...
  */
  ...
  it("101 accounts. 1 liquidation. 100 accounts do Cdp operations (apply rewards)", async () => {
    ...
    await th.openCdp_allAccounts(accounts.slice(0, 99), contracts, dec(1, 'ether'), dec(170, 18))
  ...
  /* ABDK64, no error correction:
    ...
    EBTCDebt left in Default Pool is: 180 
  ...
  */
  ...
  it("1001 accounts. 1 liquidation. 1000 accounts do Cdp operations (apply rewards)", async () => {
    ...
    await th.openCdp_allAccounts(accounts.slice(0, 999), contracts, dec(1, 'ether'), dec(170, 18))
  ...
  */
  ...
  it("11 accounts. 10 liquidations. Check (ActivePool - DefaultPool) differences", async () => {
    ...
    console.log(`Accumulated EBTCDebt difference between Active and Default Pools is: ${totalEBTCDebtPoolDifference}`)
  })
  
  /* ABDK64, no error correction
    Accumulated ETH difference between Default and Active Pools is: 0
    Accumulated EBTCDebt difference between Active and Default Pools is: 0
  ...
  */
  ...
  it("11 accounts. 10 liquidations. Check (DefaultPool - totalRewards) differences", async () => {
    ...
    const totalEBTCRewards = (totalColl.mul(systemDebtRedistributionIndex)).div(_1e18_BN)
    ...
    console.log(`EBTCDebt difference between total pending rewards and DefaultPool: ${EBTCDebtRewardDifference} `)
  })

  /* ABDK64, no error correction:
    ETH difference between total pending rewards and DefaultPool: 700
    EBTCDebt difference between total pending rewards and DefaultPool: 800

    ABDK64 WITH correction:
    ETH difference between total pending rewards and DefaultPool: 300
    EBTCDebt difference between total pending rewards and DefaultPool: 400
    
    DeciMath, no error correction:
    ETH difference between total pending rewards and DefaultPool: -100
    EBTCDebt difference between total pending rewards and DefaultPool: -200

    Pure division with correction: 
    ETH difference between total pending rewards and DefaultPool: 0
    EBTCDebt difference between total pending rewards and DefaultPool: 0
  */
  ...
  /* ABDK64, no error correction:
    ...
    EBTCDebt difference between total pending rewards and DefaultPool: 55000
    
    ABDK64 WITH correction:
    ETH difference between total pending rewards and DefaultPool: 31000
    EBTCDebt difference between total pending rewards and DefaultPool: 31000

    DeciMath, no error correction:
    ETH difference between total pending rewards and DefaultPool: 2000
    EBTCDebt difference between total pending rewards and DefaultPool: -2000
 ...
 it("11 accounts with random ETH and proportional EBTC (180:1). 10 liquidations. Check (DefaultPool - totalRewards) differences", async () => {
  await borrowerOperations.openCdp(0, 0,  accounts[999], { from: accounts[999], value: dec(100, 'ether') })

  await th.openCdp_allAccounts_randomETH_ProportionalEBTC(1, 2, accounts.slice(0, 11), contracts, 180)
  ...
  /* ABDK64, no error correction:
    ...
    EBTCDebt difference between total pending rewards and DefaultPool: 8000

    ABDK64 WITH correction:
    ETH difference between total pending rewards and DefaultPool: 300
    EBTCDebt difference between total pending rewards and DefaultPool: 300
    ...
    Pure division with correction:
    ETH difference between total pending rewards and DefaultPool: 100
    EBTCDebt difference between total pending rewards and DefaultPool: 100
  */

  it("101 accounts with random ETH and proportional EBTC (180:1). 100 liquidations. Check 1) (DefaultPool - totalDistributionRewards) difference, and 2) ", async () => {
    await borrowerOperations.openCdp(0, 0,  accounts[999], { from: accounts[999], value: dec(1000, 'ether') })

    await th.openCdp_allAccounts_randomETH_ProportionalEBTC(1, 2, accounts.slice(0, 101), contracts, 180)
  ...
  /* ABDK64, no error correction:
    ...
    EBTCDebt difference between total pending rewards and DefaultPool: 61000

    ABDK64 WITH correction:
    ETH difference between total pending rewards and DefaultPool: 31300
    EBTCDebt difference between total pending rewards and DefaultPool: 30000
    ...
    EBTCDebt difference between total pending rewards and DefaultPool: 1000
  */
  ...
  it("11 accounts. 10 liquidations, partial offsets. Check (DefaultPool - totalRewards) differences", async () => {
   // Acct 99 opens cdp with 100 EBTC
    ...
    // On loop: Account[99] adds 10 EBTC to pool -> a cdp gets liquidated and partially offset against SP, emptying the SP
    for (account of accounts.slice(1, 11)) {
    ...
    const totalEBTCRewards_Distribution = (totalColl.mul(systemDebtRedistributionIndex)).div(_1e18_BN)
    ...
    console.log(`EBTCDebt difference between total pending distribution rewards and DefaultPool: ${EBTCDebtRewardDifference} `)
  })

  /* ABDK64, no error correction
    ETH difference between total pending distribution rewards and DefaultPool: 550
    EBTCDebt difference between total pending distribution rewards and DefaultPool: 600
    
    DeciMath, no error correction:
    ETH difference between total pending distribution rewards and DefaultPool: 150
    EBTCDebt difference between total pending distribution rewards and DefaultPool: -200
    
    Pure division with error correction:
    ETH difference between total pending distribution rewards and DefaultPool: 50
    EBTCDebt difference between total pending distribution rewards and DefaultPool: 0
  */
  ...
  /* ABDK64, no error correction
    ...
    EBTCDebt difference between total pending distribution rewards and DefaultPool: 8900
  ...
  */
  ...
  it("11 accounts. 10 Borrowers add to SP. 1 liquidation, 10 Borrowers withdraw all their SP funds", async () => {
    // Acct 99 opens cdp with 100 EBTC
     ...
     // 9 Accounts open cdps and provide to SP
     await th.openCdp_allAccounts(accounts.slice(1, 11), contracts, dec(1, 'ether'), dec(100, 18))
    ...
    /* Sometimes, the error causes the last EBTC withdrawal from SP to underflow and fail. 
    ...
    console.log(`EBTC insufficiency in Stability Pool is ${SP_EBTC_Insufficiency}`)
   })

   /* ABDK64, no error correction
      Sometimes subtraction overflows on last withdrawal from SP - error leaves insufficient EBTC in Pool.
      ...
      EBTC insufficiency in Stability Pool is 530
      
      DeciMath, no error correction:
      Surplus ETH left in in Stability Pool is 0
      EBTC insufficiency in Stability Pool is 0
   ...
   it("101 accounts. 100 Borrowers add to SP. 1 liquidation, 100 Borrowers withdraw all their SP funds", async () => {
    // Acct 99 opens cdp with 100 EBTC
     ...
     // 10 Accounts open cdps and provide to SP
     await th.openCdp_allAccounts(accounts.slice(1, 101), contracts, dec(1, 'ether'), dec(100, 18))
   ...
   /* ABDK64, no error correction
    ...
    EBTC insufficiency in Stability Pool is 5300
   ...
   */
   ...
   /* ABDK64, no error correction
      ...
      EBTC insufficiency in Stability Pool is 442
      ...
      EBTC insufficiency in Stability Pool is 67

      Pure division with error correction:
      Surplus ETH left in in Stability Pool is 446
      EBTC insufficiency in Stability Pool is 507
    */
   ...
   it("101 accounts. 100 Borrowers add to SP, random EBTC amounts. 1 liquidation, 100 Borrowers withdraw all their SP funds", async () => {
    // Acct 99 opens cdp with 100 EBTC
     ...
     // 100 Accounts open cdps and provide to SP
     await th.openCdp_allAccounts(accounts.slice(1, 101), contracts, dec(1, 'ether'), dec(100, 18))
   ...
   /* ABDK64, no error correction
    ...
    EBTC insufficiency in Stability Pool is 1112

    DeciMath, no error correction:
    Surplus ETH left in in Stability Pool is 1373
    EBTC insufficiency in Stability Pool is -13

    Pure division with no error correction:
    Surplus ETH left in in Stability Pool is 4087
    EBTC insufficiency in Stability Pool is 1960

    Pure division with error correction:
    Surplus ETH left in in Stability Pool is 3072
    EBTC insufficiency in Stability Pool is 452
  */ 
 ...
 it("501 accounts. 500 Borrowers add to SP, random EBTC amounts. 1 liquidation, 500 Borrowers withdraw all their SP funds", async () => {
  // Acct 99 opens cdp with 100 EBTC
   ...
   // 500 Accounts open cdps and provide to SP
   await th.openCdp_allAccounts(accounts.slice(1, 501), contracts, dec(1, 'ether'), dec(100, 18))
  ...
  /* ABDK64, no error correction:
    ...
    EBTC insufficiency in Stability Pool is -8445

    Pure division, no correction:
    Surplus ETH left in in Stability Pool is 18708
    EBTC insufficiency in Stability Pool is 25427

    Pure division with error correction:
    Surplus ETH left in in Stability Pool is 1573
    EBTC insufficiency in Stability Pool is 6037
  */ 

 it("10 accounts. 10x liquidate -> addColl. Check stake and totalStakes (On-chain data vs off-chain simulation)", async () => {
  await borrowerOperations.openCdp(0, 0,  accounts[999], { from: accounts[999], value: dec(1000, 'ether') })
  await th.openCdp_allAccounts(accounts.slice(1, 11), contracts, dec(1, 'ether'), dec(170, 18))
  ...
  // Loop over account range, alternately liquidating a Cdp and opening a new cdp
  for (i = 1; i < 10; i++) {
    ...
    // New cdp opening creates a new stake, then adds 
    ...
    // Liquidate Cdp 'i', and open cdp from account '999 - i'
...
it("100 accounts. 100x liquidate -> addColl. Random coll. Check stake and totalStakes (On-chain data vs off-chain simulation)", async () => {
  await borrowerOperations.openCdp(0, 0, accounts[999], { from: accounts[999], value: dec(1000, 'ether') })
  await th.openCdp_allAccounts(accounts.slice(1, 101), contracts, dec(1, 'ether'), dec(170, 18))
...
it("11 accounts with random large coll, magnitude ~1e8 ether. 1 liquidation. 10 accounts do Cdp operations (apply rewards)", async () => {
  ...
  // Cdps open with 100-200 million ether
  await th.openCdp_allAccounts_randomETH(100000000, 200000000, accounts.slice(1, 10), contracts, dec(170, 18))
...
/* DeciMath:
  ...
  EBTCDebt left in Default Pool is: 308731912

  Pure division, correction:
  ETH left in Default Pool is: 1136050360
  EBTCDebt left in Default Pool is: 997601870

  Pure division, no correction:
  ETH left in Default Pool is: 810899932
  EBTCDebt left in Default Pool is: 535042995
*/
...
it("101 accounts with random large coll, magnitude ~1e8 ether. 1 liquidation. 500 accounts do a Cdp operation (apply rewards)", async () => {
  ...
  await borrowerOperations.openCdp(0, dec(170, 18), accounts[0], { from: accounts[0], value: dec(1, 'ether') })
   ...
   // Cdps open with 100-200 million ether
  await th.openCdp_allAccounts_randomETH(100000000, 200000000, accounts.slice(1, 100), contracts, dec(170, 18))
 ...
 /*
  ...
  EBTCDebt left in Default Pool is: 14696382412

  Pure division, correction:
  ETH left in Default Pool is: 9281255535
  EBTCDebt left in Default Pool is: 5854012464
  */

// --- Liquidations, large coll and debt ---

it("11 accounts with random ETH and proportional EBTC (180:1). 10 liquidations. Check (DefaultPool - totalRewards) differences", async () => {
  await borrowerOperations.openCdp(0, 0,  accounts[999], { from: accounts[999], value: dec(1, 27) })

  // Cdps open with 100-200 million ether and proportional EBTC Debt
  await th.openCdp_allAccounts_randomETH_ProportionalEBTC(100000000, 200000000, accounts.slice(0, 11), contracts, 180)
...
/* 
  ...
  EBTCDebt difference between total pending rewards and DefaultPool: 12000000000

  Pure division with correction:
  ETH difference between total pending rewards and DefaultPool: 1000000000
  EBTCDebt difference between total pending rewards and DefaultPool: 1000000000
  */

  it("101 accounts with random ETH and proportional EBTC (180:1). 100 liquidations. Check 1) (DefaultPool - totalDistributionRewards) difference, and 2) ", async () => {
    await borrowerOperations.openCdp(0, 0,  accounts[999], { from: accounts[999], value: dec(1, 28) })

    // Cdps open with 100-200 million ether and proportional EBTC Debt
    await th.openCdp_allAccounts_randomETH_ProportionalEBTC(100000000, 200000000, accounts.slice(0, 101), contracts, 180)
  ...
  /*
    ...
    EBTCDebt difference between total pending rewards and DefaultPool: 870000000000

    Pure division with correction:
    ETH difference between total pending rewards and DefaultPool: 10000000000
    EBTCDebt difference between total pending rewards and DefaultPool: 10000000000
  */
})
 ...
 Test to see if error is stable or grows. 
  ...
  1) Reward applications accumulate ETH and EBTCDebt error in DefaultPool

  2) Liquidations accumulate ETH and EBTCDebt error in DefaultPool
  ...
  5) StabilityPool Withdrawals can accumulate EBTCLoss in the StabilityPool (i.e. they distribute too much EBTC), and can block
