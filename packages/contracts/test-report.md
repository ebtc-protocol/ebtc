...
$ hardhat test
  ...
  Contract: BorrowerOperations
    Without proxy
      ...
      ✓ withdrawEBTC(): reverts when withdrawal would leave trove with ICR < MCR (516ms)
      ...
      ✓ withdrawEBTC(): reverts when calling address does not have active trove (370ms)
      ...
      ✓ withdrawEBTC(): reverts when withdrawal would bring the trove's ICR < MCR (347ms)
      ...
      ✓ repayEBTC(): reverts when repayment would leave trove with ICR < MCR (392ms)
      ✓ repayEBTC(): Succeeds when it would leave trove with net debt >= minimum net debt (435ms)
      ✓ repayEBTC(): reverts when it would leave trove with net debt < minimum net debt (256ms)
      ✓ repayEBTC(): reverts when calling address does not have active trove (431ms)
      ✓ repayEBTC(): reverts when attempted repayment is > the debt of the trove (418ms)
      ...
      ✓ adjustTrove(): reverts when EBTC repaid is > debt of the trove (451ms)
      ...
      ✓ openTrove(): increases EBTC debt in ActivePool by the debt of the trove (162ms)
...
B stake after A11: 39999999999999999998008332745
  ...
  Contract: TroveManager - in Recovery Mode
    ...
    ✓ liquidate(), with 110% < ICR < TCR, and StabilityPool EBTC > debt to liquidate: offsets the trove entirely with the pool (1265ms)
    ✓ liquidate(), with ICR% = 110 < TCR, and StabilityPool EBTC > debt to liquidate: offsets the trove entirely with the pool, there’s no collateral surplus (1382ms)
    ...
    ✓ liquidate(), with 110% < ICR < TCR, and StabilityPool EBTC > debt to liquidate: can liquidate troves out of order (2667ms)
    ...
    ✓ liquidate(), with ICR > 110%, and StabilityPool EBTC < liquidated debt: causes correct Pool offset and ETH gain, and doesn't redistribute to active troves (1266ms)
    ✓ liquidate(), with ICR > 110%, and StabilityPool EBTC < liquidated debt: ICR of non liquidated trove does not change (2161ms)
...
gasUsed:  636956
    ...
    ✓ batchLiquidateTroves(), with 110% < ICR < TCR, and StabilityPool EBTC > debt to liquidate: can liquidate troves out of order (1357ms)
