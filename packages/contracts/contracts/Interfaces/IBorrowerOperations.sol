...
interface IBorrowerOperations {
    ...
    event CdpUpdated(bytes32 indexed _cdpId, address indexed _borrower, uint _debt, uint _coll, uint stake, uint8 operation);
    ...
    function moveETHGainToCdp(bytes32 _cdpId, bytes32 _upperHint, bytes32 _lowerHint) external payable;
