...
abstract contract BeforeAfter is BaseStorageVariables, LogUtils {
    ...
    function _printCdpSystemState() internal {
        ...
        console.log("systemStEthFeePerUnitIndexError :", cdpManager.systemStEthFeePerUnitIndexError());
        console.log("");
    ...
    function _printAllCdps() internal {
        ...
        while (node != bytes32(0)) {
            ...
            console.log("cdpDebtRedistributionIndex  :", cdpManager.cdpDebtRedistributionIndex(node));
            console.log("cdpStEthFeePerUnitIndex     :", cdpManager.cdpStEthFeePerUnitIndex(node));
            console.log("hasPendingRedistributedDebt :", cdpManager.hasPendingRedistributedDebt(node));
            console.log("getPendingRedistributedDebt :", cdpManager.getPendingRedistributedDebt(node));
            console.log("");
