...
abstract contract TargetFunctions is Properties {
    ...
    function redeemCollateral(
        ...
        if (_maxIterations == 1) {
            gte(vars.activePoolDebtBefore, vars.activePoolDebtAfter, "CDPM_05_GLOBAL"); /// @audit Global debt should not increase under any cirmunstance
            gte(vars.cdpDebtBefore, vars.cdpDebtAfter, CDPM_05); /// @audit This should not break after the fix as we check for redistributed bad debt in `cdpDebtBefore`
