...
abstract contract PropertiesDescriptions {
    ...
    string constant P_02 =
        "P-02: Any eBTC holder (whether or not they have an active CDP) may redeem their eBTC unless the system is in Recovery Mode";
    string constant P_03 = "P-03: After any operation, the TCR must be above the CCR";
    string constant P_07 =
    ...
    string constant P_49 = "P-49: Removing collateral decreases the Nominal ICR";
    string constant P_51 = "P-51: TCR must increase after a liquidation";
