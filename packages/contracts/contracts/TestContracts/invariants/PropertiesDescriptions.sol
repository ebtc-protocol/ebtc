...
abstract contract PropertiesDescriptions {
    ...
    string constant CSP_02 = "CSP-02: The sum of all surpluses is equal to the value of getTotalSurplusCollShares";
    ...
    // General
    ///////////////////////////////////////////////////////
    string constant GENERAL_01 = "GENERAL-01: After any operation, the system should not enter in Recovery Mode";
    ...
    string constant GENERAL_08 = "GENERAL-08: At all times TCR = SUM(COLL)  * price / SUM(DEBT) of all CDPs";
    ...
    string constant GENERAL_11 = "GENERAL-11: The TCR pre-computed (TCRNotified) is the same as the one after all calls";
    string constant GENERAL_12 = "GENERAL-12: The synchedTCR matches the TCR after accrual (as returned by CrLens)";
    ...
    string constant L_09 = "L-09: Undercollateralized liquidations are also incentivized with the Gas Stipend";
    ...
    string constant PF_04 = "PF-04: The price feed should never report an outdated price if chainlink is Working";
    string constant PF_05 = "PF-05: The price feed should never use the fallback if chainlink is Working";
