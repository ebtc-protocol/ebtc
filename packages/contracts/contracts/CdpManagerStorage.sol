...
contract CdpManagerStorage is EbtcBase, ReentrancyGuard, ICdpManagerData, AuthNoOwner {
    ...
    function _getPendingRedistributedDebt(
        ...
        if (_debtIndexDiff > 0) {
            pendingEBTCDebtReward = (_collShareBefore * _debtIndexDiff) / DECIMAL_PRECISION;
        } else {
            return (0, 0);
        }
    }
    ...
    function _calcSyncedAccounting(
        ...
        uint256 _collShareBefore = _newCollShare;
        ...
        (
            ...
            uint256 _debtIndexDelta
        ) = _getSyncedCdpDebtAndRedistribution(_cdpId, _collShareBefore);
